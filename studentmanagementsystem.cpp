...
// this program is created in DEV c++ and also well tested in Visual Studio Code
// this program  is not runable in Turbo C++ forgive me for any inconveniance

//STUDENT MANAGEMENT SYSTEM
// source code is available in discription box



// below added all necessary header files
#include<iostream>
#include<conio.h>
#include<cstdlib>
#include<fstream>
...
int main()
{
	...
	switch(value)
	{
		...
		case 5:
			...
			break;
		case 6:
			cout<<"This program is created by ...(your name here).....\n Thank You";
...
// Source code is available in description
